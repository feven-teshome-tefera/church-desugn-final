...
//             <p className="text-lg mb-4 opacity-90">Preview</p>
...
//                     className="border border-border rounded-lg p-8 hover:shadow-md transition flex items-center gap-6"
//                   >
//                     <Icon size={48} className="text-primary flex-shrink-0" />
//                     <div>
