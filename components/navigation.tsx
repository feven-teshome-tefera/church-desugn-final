...
export function Navigation() {
  ...
  return (
    ...
    {/* <nav className="sticky top-0 z-50 bg-background/50 backdrop-blur-md border-b border-border/30"> */}
      <div className=" max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className=" flex justify-between items-center h-16">
          <div className=" flex items-center gap-3">
            {/* <div className="absolute inset-0 bg-[rgba(123,35,173,0.35)] backdrop-blur-sm" /> */}
          <div className=" ">
               <Image
            ...
            <div>
              <h1 className="text-primary-gradient font-bold text-xl ">
               Ethiopian Emmanuel Baptist Church
              </h1>
              {/* <p className="text-xs text-muted-foreground">Foundation in Christ</p> */}
                  </div>
            </div>
